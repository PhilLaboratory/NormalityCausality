...
(is this what's enough? and knowledge*outcome interaction interpretation correct?)
Broadly, the ratings helped us verify the effectiveness of our study design: improbable outcomes were perceived as less normal, even though not necessarily less good. We did see, however, a marginally significant *Knowledge* \times *Outcome* interaction in valence ratings, suggesting that knowledge was associated with more goodness than ignorance in probable secondary outcomes, not improbable ones.
...
## Discussion
Results from Experiment 3c support the effectiveness of scenario building, where bad secondary outcomes were ascribed lower hedonic valence than good ones. Another interesting finding from 3c is that bad outcomes were perceived as less normal than good outcomes, echoing the general account that normality blends both descriptive and prescriptive normality. 

(there's a knowledge*harm type interaction in both studies, worth discussing? but 3b didn't show that abnormal outcomes were seen as less good...)

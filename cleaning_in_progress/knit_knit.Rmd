...
At a broad level the morality and rationality ratings confirmed that our manipulations worked and critically we observed the an effect of the agent's knowledge. For example, immorality ratings were highest when an agent knowingly brought about harm to another, and agents who knowingly hared themselves were judged to be highly irrational but not immoral. Interestingly, we observed two unpredicted effects in ratings of rationality. First, participants rated agents who knowingly harming others to be irrational in addition to immoral, even though the action often benefited the agent in some way. Second, agents were seen as more irrational for knowingly causing harm when the secondary, unforeseen, outcome was negative rather than positive. We will return to these ratings and their relationship to causal judgments in the final set of analyses.
...
Using the same causal chains and scenarios as Experiment 3a, we asked participants to provide valence and normality judgments in Experiment 3b, namely, to what extent they thought the outcome was a good thing and to what extent they thought it was a normal thing to have happened. Doing so serves the purpose of a manipulation check on the various vignettes used, helping us verify the validity of our scenario construction. In addition, the variance embedded in the ratings enables us to better track patterns of valence and normality judgments without relying solely on the binary labels (e.g., probable vs. improbable outcomes). Furthermore, examining valence and normality judgments of probable or improbable outcomes are is helpful in not only directly comparing descriptive and prescriptive norms, but also tying things together under the broader normality framework. 
...
Mirroring Experiment 3b, we once again asked participants to provide their ratings of valence and normality, this time on negative or positive outcomes. Evaluating the results of Experiments 3b and 3c in parallel will shed light on the robustness of the theory that normality perception combines both descriptive (what typically happens) and prescriptive (what should happen) components, which will inform our understanding about how normality inluences causal reasoning (especially in contexts involving norm violations?).

...
# Experiment 2d: Morality, rationality and counterfactual judgments in cases of bad/good outcomes and prescriptive norm violations
...
[Write summary sentence of what we did again at a high level, for example: This experiment built on the prior ones by additionally asking participants to make counterfactual judgments and also...]
...
[Then let's focus on the CF results first! So, moving your bit below up here.]
...
[couple of quick notes: the parenthetical "(even though we did not see the same main effect of outcome valence here)" seems too casual. Maybe provide more context and break that up into a separate sentence if it's important; if it's not, then just leave it out.]
...
The morality ratings helped us affirm the success of vignette construction, such that unethical scenarios were indeed considered less moral by participants than their counterparts, and this effect was even more salient when agents acted with knowledge.  
(The problem is that there's no norm effect for rationality, so should I talk about the knowledge and outcome effect?) The rationality ratings, on the other hand, revealed that agents were perceived as irrational as long as they acted knowingly or the secondary outcome was negative. It is worth noting that we did see a stronger inclination to attribute irrationality to agents who did not act in their own best interest when the secondary outcome was aversive than when it turned out to be positive.
  
[the part below is great! I only have small edits, but this seems right on to me.]
...
[in the paragraph below, I think I would stick more closely to what you wrote above. so focusing on whether the contribution of outcome to the interaction is really a matter of prescriptive norms, or a matter of normality more generally. If it's the latter case, then shoudl expect the same interaction with descriptive norms.]

We previously probed the effect of prescriptive norm by manipulating the valence of outcomes, and learned that the two types of prescriptive norms exert similar influence on causal selection. But is this effect specific to prescriptive norms, or is about normality in general? Existing literature argues that people's perception of normality integrates representations of both descriptive and prescriptive norms, namely, what is statistically expected and what is prescriptively ideal (Bear & Knobe, 2017). (the same interaction with descriptive norms?? but we're not changing the norm violation.)

Relatedly (?), we hope to further explore why outcome valence is interacting with knowledge in causal selection, and one possibility is that such interaction arises not from hedonic valence but from the probability of the outcome.
...
[the other key thing to note is that outcome valence is basically prescriptive value, that is, it was either good or bad for that to happen, so it was moving from some kind of more prescriptive norm to a more descriptive norm]

...
Experiment 4 expands on our understanding of causal cognition by examining modal and counterfactual judgments, that is, how participants reasoned about the plausibility of alternative possibilities and the likelihood of different outcomes under such hypothetical alternatives. Consistent with previous studies, we found that outcome normality played a crucial role in shaping participants' judgments, such that when secondary outcomes were abnormal (i.e., bad or improbable), participants were less inclined to believe that agents could have acted differently and alternative consequences could have happened if the antecedent changed. We also observed the *Knowledge* $\times$ *Outcome* interaction in counterfactual judgment, whereby participants were more likely to believe a consequence could have been circumvented if the agent acted knowingly when the outcome was abnormal than when it was normal (this supports counterfactual accessibility bc it shows K*O interaction or is that what I'm supposed to talk about in potency results?). We also probed potency, a concept intended to capture the combined impact of the perceived likelihood of counterfactual antecedent and the perceived likelihood of counterfactual consequence on causal judgments. According to our analyses, knowledge, outcome normality, and their interaction, all contribute to potency. (check mediation! also, no interaction between potency and normality.)

(How does this compare counterfactual accessibility and counterfactual potency...?)

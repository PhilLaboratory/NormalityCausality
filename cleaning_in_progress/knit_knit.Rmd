...
Following results from Experiment 2a-2c, Experiment 2d delved into participants' morality and rationality ratings on the same scenarios to investigate how moral and rational norm violations are perceived, at the same time serving as a manipulation check. Additionally, we collected people's counterfactual judgments for the same set of stimuli to examine what is actually driving the effect observed earlier.


[checking variance (??) by asking for morality and rationality ratings
counterfactual: driver of this effect]

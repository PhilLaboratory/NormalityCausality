...
In this experiment, we collected participants' judgments of valence and normality of secondary outcomes. As expected, improbable outcomes were perceived as less normal than probable outcomes; however, they were not necessarily judged as less positive in valence. This finding suggests that the interaction effect of outcome probability and agent knowledge previously observed in Experiment 3a cannot be simply explained by improbable outcomes being perceived as negative in valence. Moreover, readers may recall that difference in causal judgments was more pronounced between knowledgeable and ignorant agents for both bad outcomes (as opposed to good outcomes) and improbable outcomes (as opposed to probable outcome). Taken together, these results suggest that valence and probability should not be conflated with one another. Instead, they should both be understood within a broader framework of normality.  

In the next experiment, we return to manipulating outcome valence (rather than probability) and ask participants to evaluate valence and normality for good and bad outcomes. If bad outcomes are indeed seen as less normal, we can infer that valence factors in normality cognition, and therefore move one step closer to a more parsimonious account of normality being impacted by both statistical probability and hedonic valence.
...
## Discussion
Results from Experiment 3c lent support to the effectiveness of our scenario building, where bad secondary outcomes were ascribed lower hedonic valence than good ones. Additionally, bad outcomes were perceived as less normal than good outcomes, echoing the general account that normality blends both descriptive and prescriptive normality. In other words, varying valence in outcomes changes not only the perceived goodness but also affects normality perception.

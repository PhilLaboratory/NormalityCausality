...
Across all of these cases we ask participants both to make judgments of whether the distal cause "caused" the final outcome, and to make a counterfactual judgments.
||
...
Given the findings and limitations of Experiment 1, we directly addresses the confound between outcome valence and the morality of the agent's action. We did this by introducing two separate outcomes that arose from the agent's actions. We used the first (primary) outcome to manipulate whether the agent's action would be seen as violating a norm, by having the agent knowingly or ignorantly acting in a way that caused harm. In addition, we used the secondary outcome to independently manipulate the valence of a subsequent downstream consequence of their action. The agent was always ignorant of this secondary outcome, regardless of whether it was objectively good or bad. Critically, we still always asked whether the agent caused the downstream, secondary outcome. This design allowed us to dissociate whether or not the agent violated a norm from whether the agent acted in way that eventually led to negative or positive outcome.

A second innovation in this study was to introduce a second kind of prescriptive norm violation, namely, violations of norms of rationality. Moral norm violations often involve an agent bringing about an outcome that is not in someone else's best interest, while rational norm violations often involve agents bringing about outcomes that are not in their own best interest. In this study, we also systematically vary whether the agent violated a moral or rational norm and ask whether the observed effect on causal judgments is specific to moral norm violations or extends to other kinds of prescriptive norm violations. This addition should help us address a concern raised by researchers who argue that the effect of normality is driven disproportionately by the immorality of actions. [CITEs]

The main causal chain in Experiment 2a-2d is summarized in *Fig.* 4: we used scenarios where an agent (i.e., the distal cause) performed an action that became the proximal cause for a secondary outcome. In addition to this, agents in Experiments 2a-d would at the same time, either knowingly or ignorantly, bring about some harm to others or to themselves. The distal cause thus could be a knowing agent or an ignorant agent for this detrimental primary outcome. We then asked for participants' causal judgments on the *secondary outcome*. For Experiment 2a particularly, we kept the valence of the secondary outcome to always be negative. 
...
Experiment 2a revealed two insights that have not been widely documented in existing literature: first, agents who knowingly preformed actions that were detrimental to themselves or to others were judged as more causal of the subsequent negative outcome, even when the immorality or irrationality of such action was completely independent of the eventual secondary outcome; second, for causation, what matters is knowledge about norm violation in primary outcomes, not knowledge about valence of secondary outcomes, such that knowledgeable agents were always seen as more causal for the harm they brought about regardless, despite being totally ignorant of the downstream consequence of their action. Taken together, these findings suggest that causal judgment is tied with the nature of the agent's action and its immediate consequence, especially whether it is performed with explicit knowledge, but not with its downstream consequence. Plus, that moral norm violation does not render a different effect from rational norm violation implies that the underlying mechanism for causal selection might be identical or at least similar for different types of prescriptive norms. Next, we went on to test if the findings differentiate in cases where the secondary outcomes are always good in valence.


# Experiment 2b: Causal judgment in cases of good outcomes and prescriptive norm violations

In Experiment 2a, we started teasing apart primary and secondary outcomes and we held fixed the secondary outcome to be negative to ensure strong experimental manipulation. However, does the outcome valence have additional effect on causal judgments? To investigate this exact question – whether the effect we see in Experiment 2a manifests in positive outcomes like it did in negative outcomes, such that knowledgeable agents are always ascribed more causation than ignorant ones – we designed Experiment 2b that differs from Experiment 2a in only one way: the secondary outcome resulted from the intermediate event was always positive in this study. Again, we asked for participants' causal judgments on the *secondary outcome*. Some previous work has found an effect of moral norm violations even in good outcomes, while others argue that this effect is attenuated or even nonexistent in the face of positive outcomes (e.g., Alicke, Rose & Bloom, 2011). 
...
Following results from Experiment 2a-2c, Experiment 2d delved into participants' actual morality and rationality ratings to investigate the variance. Additionally, we collected people's counterfactual judgments for the same set of stimuli to examine what is actually driving the effect.
